...
/**
 * Presentational auth card. Real Supabase auth wiring lands in Fase 2 — for now
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border bg-background p-6 shadow-soft">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {isSignup ? "Первый бот — бесплатно, без карты." : "Войдите, чтобы продолжить."}
          </p>

          <button
            onClick={() => setNote("Вход через Google подключим в следующем обновлении.")}
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              setNote("Спасибо! Авторизацию по email активируем в ближайшем обновлении.");
            }}
            className="space-y-3"
          >
            <input
            ...
            <Button type="submit" className="w-full">
              {isSignup ? "Создать аккаунт" : "Отправить ссылку для входа"}
            </Button>
          </form>
